...
For setting up [AdService], creating [AdRequest] and [Advertisement], you can follow the [previous tutorial](https://vm-mobile-sdk.github.io/nextgen-adsdk-android-release/5.3.0/first-steps.html) exactly, as it does not include any Compose-specific code.
