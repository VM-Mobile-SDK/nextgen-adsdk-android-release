...
You can download this [this project] which already implements all the steps of this tutorial.
...
Make sure you have added the correct packages from the [readme].
...
[this project]:(https://github.com/VM-Mobile-SDK/nextgen-adsdk-android-tutorial/tree/built-in-capabilities/first-step)
[readme]:(https://github.com/VM-Mobile-SDK/nextgen-adsdk-android-release/blob/main/README.md)
...
[AdService.networkId]:(https://vm-mobile-sdk.github.io/nextgen-adsdk-android-release/5.0.0/sdk_core/com.adition.sdk_core.api.core/-ad-service/network-id.html)
[AdService.configure]:(https://vm-mobile-sdk.github.io/nextgen-adsdk-android-release/5.0.0/sdk_presentation_compose/com.adition.sdk_presentation_compose.api/-ad-service-extension/index.html)

[AdError]:(https://vm-mobile-sdk.github.io/nextgen-adsdk-android-release/5.0.0/sdk_core/com.adition.sdk_core.api.entities.exception/-ad-error/index.html)
